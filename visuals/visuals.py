...
class Visuals:
   ...
   def __init__(self,linkData):
      ...
      wheelValuesCount=len(linkData) # The amount of values in the wheel - This will be replaced to be adaptive to the link placed in the wheel.
      window=MainWindow(size,linkData) # Creates the Main Window
      ...
      window.shapeGroups[2].setLinkData(linkData)
